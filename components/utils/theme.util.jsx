...
export default function SetTheme() {
  ...
  useEffect(() => {
    ...
    if (canvasEle) {
      ...
      ['SCREEN', 'LINEAR_LIGHT'].reduce((e, n, t) => Object.assign(e, { [n]: t }), {});
      class MiniGl {
                        ...
                        return (
                          ...
                          `uniform struct ${s} \n\t\t\t\t\t\t\t\t{\n` +
                            Object.entries(i.value)
                              .map(([e, t]) => t.getDeclaration(e, n).replace(/^uniform/, ''))
                              .join('') +
                            `\n} ${e}${t > 0 ? `[${t}]` : ''};`
                        );
                      }
              ...
              PlaneGeometry: {
                ...
                value: class {
                  constructor(e, n, t, i, o) {
                    (r.createBuffer(),
                      (this.attributes = {
                        position: new s.Attribute({ target: r.ARRAY_BUFFER, size: 3 }),
                  ...
                  setTopology(e = 1, n = 1) {
                    ...
                    ((t.xSegCount = e),
                      ...
                      (t.attributes.uvNorm.values = new Float32Array(2 * t.vertexCount)),
                    ...
                    for (let e = 0; e <= t.ySegCount; e++)
                      for (let n = 0; n <= t.xSegCount; n++) {
                        ...
                        if (
                          ...
                          (t.attributes.uvNorm.values[2 * i] = (n / t.xSegCount) * 2 - 1),
                          (t.attributes.uvNorm.values[2 * i + 1] = 1 - (e / t.ySegCount) * 2),
                          n < t.xSegCount && e < t.ySegCount)
                        ) {
                          const s = e * t.xSegCount + n;
                          ((t.attributes.index.values[6 * s] = i),
                            (t.attributes.index.values[6 * s + 1] = i + 1 + t.xSegCount),
                            (t.attributes.index.values[6 * s + 2] = i + 1),
                            (t.attributes.index.values[6 * s + 3] = i + 1),
                            (t.attributes.index.values[6 * s + 4] = i + 1 + t.xSegCount),
                            (t.attributes.index.values[6 * s + 5] = i + 2 + t.xSegCount));
                        }
                      }
                  ...
                  setSize(e = 1, n = 1, t = 'xz') {
                    ...
                    for (let e = 0; e <= i.ySegCount; e++) {
                      ...
                      for (let s = 0; s <= i.xSegCount; s++) {
                        const r = o + s * a,
                          l = e * (i.xSegCount + 1) + s;
                        ((i.attributes.position.values[3 * l + 'xyz'.indexOf(t[0])] = r),
                          (i.attributes.position.values[3 * l + 'xyz'.indexOf(t[1])] = -n));
                      }
                    }
                    (i.attributes.position.update(),
                      s.debug('Geometry.setSize', { position: i.attributes.position }));
                  }
                },
              },
              Mesh: {
                ...
                value: class {
                  ...
                  draw() {
                    (r.useProgram(this.material.program),
                      this.material.uniformInstances.forEach(({ uniform: e, location: n }) =>
                        e.update(n)
                      ),
                      this.attributeInstances.forEach(({ attribute: e, location: n }) => e.use(n)),
                      r.drawElements(
                  ...
                  attach(e, n) {
                    ...
                    return (
                      this.target === r.ARRAY_BUFFER &&
                        ...
                        r.vertexAttribPointer(t, this.size, this.type, this.normalized, 0, 0)),
                      t
                    );
                  }
                  use(e) {
          ...
          (e(this, 'el', void 0),
            ...
            e(this, 'animate', (e) => {
              if (!this.shouldSkipFrame(e) || this.isMouseDown) {
                if (
                  ((this.t += Math.min(e - this.last, 1e3 / 15)), (this.last = e), this.isMouseDown)
                ) {
                  let e = 160;
